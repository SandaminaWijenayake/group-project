      ...
      <div className="filterPanel">
        ...
        <Accordion>
          <AccordionSummary
            ...
            id="panel2a-header"
          >
            <Typography>Country of Residence</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        ...
        <Accordion>
          <AccordionSummary
            ...
            id="panel2a-header"
          >
            <Typography>Min Education Level</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        ...
        <Accordion>
          <AccordionSummary
            ...
            id="panel2a-header"
          >
            <Typography>Food Preference</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        ...
        <Accordion>
          <AccordionSummary
            ...
            id="panel2a-header"
          >
            <Typography>Differently Abled</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
